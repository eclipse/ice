/**
 */
package org.eclipse.ice.developer.apps.docker.environment.util;
...
public class EnvironmentAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ice.developer.apps.docker.environment.DockerEnvironment <em>Docker Environment</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ice.developer.apps.docker.environment.DockerEnvironmentBuilder <em>Docker Environment Builder</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
