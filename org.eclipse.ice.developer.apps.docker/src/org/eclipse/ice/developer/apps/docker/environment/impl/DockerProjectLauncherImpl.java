...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Docker Project Launcher</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ice.developer.apps.docker.environment.impl.DockerProjectLauncherImpl#getLanguageprojectprovider <em>Languageprojectprovider</em>}</li>
 *   <li>{@link org.eclipse.ice.developer.apps.docker.environment.impl.DockerProjectLauncherImpl#getEnvironmentconsole <em>Environmentconsole</em>}</li>
 *   <li>{@link org.eclipse.ice.developer.apps.docker.environment.impl.DockerProjectLauncherImpl#getContainerconfiguration <em>Containerconfiguration</em>}</li>
 *   <li>{@link org.eclipse.ice.developer.apps.docker.environment.impl.DockerProjectLauncherImpl#getProjectName <em>Project Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerProjectLauncherImpl extends MinimalEObjectImpl.Container implements DockerProjectLauncher {
	...
	protected EClass eStaticClass() {
		return EnvironmentPackage.Literals.DOCKER_PROJECT_LAUNCHER;
	}
	...
	public NotificationChain basicSetLanguageprojectprovider(LanguageProjectProvider newLanguageprojectprovider, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__LANGUAGEPROJECTPROVIDER, oldLanguageprojectprovider, newLanguageprojectprovider);
	...
	public void setLanguageprojectprovider(LanguageProjectProvider newLanguageprojectprovider) {
		if (newLanguageprojectprovider != languageprojectprovider) {
			...
			if (languageprojectprovider != null)
				msgs = ((InternalEObject)languageprojectprovider).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__LANGUAGEPROJECTPROVIDER, null, msgs);
			if (newLanguageprojectprovider != null)
				msgs = ((InternalEObject)newLanguageprojectprovider).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__LANGUAGEPROJECTPROVIDER, null, msgs);
			msgs = basicSetLanguageprojectprovider(newLanguageprojectprovider, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__LANGUAGEPROJECTPROVIDER, newLanguageprojectprovider, newLanguageprojectprovider));
	}
	...
	public NotificationChain basicSetEnvironmentconsole(EnvironmentConsole newEnvironmentconsole, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__ENVIRONMENTCONSOLE, oldEnvironmentconsole, newEnvironmentconsole);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEnvironmentconsole(EnvironmentConsole newEnvironmentconsole) {
		if (newEnvironmentconsole != environmentconsole) {
			...
			if (environmentconsole != null)
				msgs = ((InternalEObject)environmentconsole).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__ENVIRONMENTCONSOLE, null, msgs);
			if (newEnvironmentconsole != null)
				msgs = ((InternalEObject)newEnvironmentconsole).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__ENVIRONMENTCONSOLE, null, msgs);
			msgs = basicSetEnvironmentconsole(newEnvironmentconsole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__ENVIRONMENTCONSOLE, newEnvironmentconsole, newEnvironmentconsole));
	}
	...
	public ContainerConfiguration getContainerconfiguration() {
		if (containerconfiguration != null && containerconfiguration.eIsProxy()) {
			...
			if (containerconfiguration != oldContainerconfiguration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__CONTAINERCONFIGURATION, oldContainerconfiguration, containerconfiguration));
			}
		}
	...
	public void setContainerconfiguration(ContainerConfiguration newContainerconfiguration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__CONTAINERCONFIGURATION, oldContainerconfiguration, containerconfiguration));
	}
	...
	public void setProjectName(String newProjectName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__PROJECT_NAME, oldProjectName, projectName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__LANGUAGEPROJECTPROVIDER:
				return basicSetLanguageprojectprovider(null, msgs);
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__ENVIRONMENTCONSOLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__CONTAINERCONFIGURATION:
				if (resolve) return getContainerconfiguration();
				return basicGetContainerconfiguration();
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER__PROJECT_NAME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER___LAUNCH_PROJECT__SOURCEPACKAGE:
				return launchProject((SourcePackage)arguments.get(0));
			case EnvironmentPackage.DOCKER_PROJECT_LAUNCHER___UPDATE_CONNECTION__INT:
