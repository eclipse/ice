...
public class VizListComponent<T> extends TransformedList<T, T> implements IListComponent<T> {
	 ...
	 */
	@XmlTransient
	protected VizJAXBHandler jaxbManipulator;
	 ...
	 */
	@XmlTransient
	Map<IVizUpdateableListener, ListEventListener<Object>> listenerMap;
	 ...
	 */
	public void copy(VizListComponent<T> list) {
		// Return if null
		if (list == null) {
			return;
		}
	...
	public boolean equals(Object otherObject) {
		...
		VizListComponent<?> castedOtherObject = null;
		...
		if (otherObject != null && (otherObject instanceof VizListComponent<?>)) {
			// See if they are the same reference on the heap
			if (this == otherObject) {
				retVal = true;
			} else {
				castedOtherObject = (VizListComponent<?>) otherObject;
	...
	public Object clone() {
		...
		VizListComponent<T> copy = new VizListComponent<T>();
		copy.copy(this);
		return copy;
	};
	...
	/* (non-Javadoc)
	 * @see org.eclipse.eavp.viz.service.datastructures.VizObject.IListComponent#setElementSource(org.eclipse.eavp.viz.service.datastructures.VizObject.IElementSource)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.eavp.viz.service.datastructures.VizObject.IListComponent#getElementSource()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.eavp.viz.service.datastructures.VizObject.IListComponent#setTableFormat(ca.odell.glazedlists.gui.WritableTableFormat)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.eavp.viz.service.datastructures.VizObject.IListComponent#getTableFormat()
	 */
