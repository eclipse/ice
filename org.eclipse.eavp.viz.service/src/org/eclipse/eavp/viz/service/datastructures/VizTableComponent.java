...
public class VizTableComponent extends VizObject{
	 ...
	 * </p>
	 */
	private Hashtable<Integer, ArrayList<VizEntry>> rowTable;
	/**
	 * <p>
	 ...
	 *         </p>
	 */
	public ArrayList<VizEntry> getRow(int index) {
		...
		ArrayList<VizEntry> rowArray = new ArrayList<VizEntry>();
	 ...
	 *         </p>
	 */
	public ArrayList<VizEntry> getRowTemplate() {
		// Local Declarations
		int i = 0;
		...
		ArrayList<VizEntry> rowTemplate = new ArrayList<VizEntry>();
	...
	public Object clone() {
		...
		VizTableComponent tableComponent = new VizTableComponent();
	...
	public boolean equals(Object otherTableComponent) {
		...
		if (otherTableComponent == null
				|| !(otherTableComponent instanceof VizTableComponent)) {
			return false;
		}
		...
		VizTableComponent castedComponent = (VizTableComponent) otherTableComponent;
