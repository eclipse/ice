 ...
 *******************************************************************************/
package org.eclipse.ice.viz.service.datastructures.resource;
...
public class VizResourceComponent extends VizListComponent<IResource> {
	...
	public ArrayList<IResource> getResources() {
		return new ArrayList<IResource>(this);
	}
	...
	public Object clone() {
		...
		VizResourceComponent outputComponent = new VizResourceComponent();
	...
	public boolean equals(Object otherResourceComponent) {
		...
		if (otherResourceComponent != null
				&& otherResourceComponent instanceof VizResourceComponent) {
