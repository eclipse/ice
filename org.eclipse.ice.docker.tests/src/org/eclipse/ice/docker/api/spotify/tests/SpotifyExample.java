...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>spotify</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SpotifyExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SpotifyPackage.eNS_URI, 
			 SpotifyPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.spotify"));
				SpotifyDockerClient root = SpotifyFactory.eINSTANCE.createSpotifyDockerClient();
