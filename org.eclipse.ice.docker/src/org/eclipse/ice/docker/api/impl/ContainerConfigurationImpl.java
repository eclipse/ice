 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#isEphemeral <em>Ephemeral</em>}</li>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#getVolumesConfig <em>Volumes Config</em>}</li>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#getRemoteSSHPort <em>Remote SSH Port</em>}</li>
 *   <li>{@link org.eclipse.ice.docker.api.impl.ContainerConfigurationImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerConfigurationImpl extends MinimalEObjectImpl.Container implements ContainerConfiguration {
	...
	protected EClass eStaticClass() {
		return DockerapiPackage.Literals.CONTAINER_CONFIGURATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerapiPackage.CONTAINER_CONFIGURATION__NAME, oldName, name));
	}
	...
	public void setEphemeral(boolean newEphemeral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerapiPackage.CONTAINER_CONFIGURATION__EPHEMERAL, oldEphemeral, ephemeral));
	}
	...
	public EList<Integer> getPorts() {
		if (ports == null) {
			ports = new EDataTypeUniqueEList<Integer>(Integer.class, this, DockerapiPackage.CONTAINER_CONFIGURATION__PORTS);
		}
		return ports;
	}
	...
	public void setVolumesConfig(String newVolumesConfig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerapiPackage.CONTAINER_CONFIGURATION__VOLUMES_CONFIG, oldVolumesConfig, volumesConfig));
	}
	...
	public void setRemoteSSHPort(int newRemoteSSHPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerapiPackage.CONTAINER_CONFIGURATION__REMOTE_SSH_PORT, oldRemoteSSHPort, remoteSSHPort));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerapiPackage.CONTAINER_CONFIGURATION__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DockerapiPackage.CONTAINER_CONFIGURATION__NAME:
				return getName();
			case DockerapiPackage.CONTAINER_CONFIGURATION__EPHEMERAL:
				return isEphemeral();
			case DockerapiPackage.CONTAINER_CONFIGURATION__PORTS:
				return getPorts();
			case DockerapiPackage.CONTAINER_CONFIGURATION__VOLUMES_CONFIG:
				return getVolumesConfig();
			case DockerapiPackage.CONTAINER_CONFIGURATION__REMOTE_SSH_PORT:
				return getRemoteSSHPort();
			case DockerapiPackage.CONTAINER_CONFIGURATION__ID:
				return getId();
		}
