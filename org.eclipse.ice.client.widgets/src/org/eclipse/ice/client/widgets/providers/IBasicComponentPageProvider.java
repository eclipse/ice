...
/**
 * This is an interface for basic component providers for Form Editors in ICE
 * that provides the set of basic component pages required to draw the UI.
 * 
 * @author Nick Stanish
 *
 */
public interface IBasicComponentPageProvider extends IPageProvider {
	 ...
	 */
	public static ArrayList<IBasicComponentPageProvider> getProviders()
			throws CoreException {
