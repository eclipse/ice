 ...
 *   Original implementation in old architecture - Jay Jay Billings
 * 
 *******************************************************************************/
 ...
 * 
 * @author Menghan Li (class), Jay Jay Billings (original implementation)
 *
 */
public class DefaultMasterDetailsPageProvider extends DefaultPageProvider
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ice.client.widgets.providers.IMasterDetailsPageProvider#
	 * getPages(org. eclipse.ui.forms.editor.FormEditor, java.util.ArrayList)
	 */
	@Override
