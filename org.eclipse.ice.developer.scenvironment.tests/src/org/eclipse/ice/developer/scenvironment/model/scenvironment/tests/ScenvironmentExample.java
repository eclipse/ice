...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>scenvironment</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenvironmentExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ScenvironmentPackage.eNS_URI, 
			 ScenvironmentPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.scenvironment"));
				SCEnvironment root = ScenvironmentFactory.eINSTANCE.createSCEnvironment();
