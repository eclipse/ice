 ...
 */
public class TimeDependentJunction extends Boundary {
	/**
	 * <!-- begin-UML-doc -->
	 * <p>
	...
	public Object clone() {
		// begin-user-code
		TimeDependentJunction temp = new TimeDependentJunction();
		temp.copy(this);
		return temp;
		// end-user-code
	}
	 ...
	 *            "UML to Java (com.ibm.xtools.transform.uml2.java5.internal.UML2JavaTransform)"
	 */
	public void copy(TimeDependentJunction otherObject) {
		// begin-user-code
