 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Model" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "ModelDB")
public class ModelDB {

    @XmlElement(name = "Model")
    protected List<ModelDBType> model;
     ...
     * 
     */
    public List<ModelDBType> getModel() {
        if (model == null) {
            model = new ArrayList<ModelDBType>();
        }
        return this.model;
    }
