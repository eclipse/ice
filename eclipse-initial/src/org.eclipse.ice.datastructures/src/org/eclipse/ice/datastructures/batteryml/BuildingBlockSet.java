...
@XmlRootElement(name = "BuildingBlockSet")
public class BuildingBlockSet {
    ...
    protected List<BuildingBlockRefType> buildingBlockSet;
     ...
     * 
     */
    public List<BuildingBlockRefType> getBuildingBlockSet() {
        if (buildingBlockSet == null) {
            buildingBlockSet = new ArrayList<BuildingBlockRefType>();
        }
