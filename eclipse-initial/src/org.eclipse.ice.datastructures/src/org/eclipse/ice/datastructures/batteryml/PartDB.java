 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Part" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "PartDB")
public class PartDB {

    @XmlElement(name = "Part")
    protected List<PartDBEntryType> part;
     ...
     * {@link PartDBEntryType }
     * 
     * 
     */
    public List<PartDBEntryType> getPart() {
        if (part == null) {
            part = new ArrayList<PartDBEntryType>();
        }
        return this.part;
    }
