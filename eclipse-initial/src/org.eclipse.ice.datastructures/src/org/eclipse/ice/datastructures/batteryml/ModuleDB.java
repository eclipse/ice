 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Module" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "ModuleDB")
public class ModuleDB {

    @XmlElement(name = "Module")
    protected List<ModuleDBEntryType> module;
     ...
     * {@link ModuleDBEntryType }
     * 
     * 
     */
    public List<ModuleDBEntryType> getModule() {
        if (module == null) {
            module = new ArrayList<ModuleDBEntryType>();
        }
        return this.module;
    }
