 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}CellSandwich" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "CellSandwichDB")
public class CellSandwichDB {

    @XmlElement(name = "CellSandwich")
    protected List<CellSandwichDBEntryType> cellSandwich;
     ...
     * {@link CellSandwichDBEntryType }
     * 
     * 
     */
    public List<CellSandwichDBEntryType> getCellSandwich() {
        if (cellSandwich == null) {
            cellSandwich = new ArrayList<CellSandwichDBEntryType>();
        }
