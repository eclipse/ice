 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Simulation" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "SimulationDB")
public class SimulationDB {

    @XmlElement(name = "Simulation")
    protected List<SimulationDBType> simulation;
     ...
     * {@link SimulationDBType }
     * 
     * 
     */
    public List<SimulationDBType> getSimulation() {
        if (simulation == null) {
            simulation = new ArrayList<SimulationDBType>();
        }
