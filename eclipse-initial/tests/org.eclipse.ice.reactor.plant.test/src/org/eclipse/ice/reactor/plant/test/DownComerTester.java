...
public class DownComerTester {
	...
	public void checkConstruction() {
		// begin-user-code
		DownComer down = new DownComer();
		assertNotNull(down.getInputs());
		assertNotNull(down.getOutputs());
		assertTrue(down.getInputs().isEmpty());
		assertTrue(down.getOutputs().isEmpty());
		// end-user-code
	}
	...
	public void checkProperties() {
		...
		// Create a DownComer with inputs and outputs, note we are
		...
		down.setInputs(inputs);
		down.setOutputs(outputs);

		// Assert that the lists were set correctly
		assertTrue(down.getInputs().equals(inputs));
		assertTrue(down.getOutputs().equals(outputs));
	...
	public void checkEquality() {
		// begin-user-code
		// Create two equal DownComeres with
		// nullary constructor
		DownComer d = new DownComer();
		d.setName("d");
		d.setDescription("Description");

		DownComer equalD = new DownComer();
		equalD.setName("d");
		equalD.setDescription("Description");

		// Check reflexivity
		assertTrue(d.equals(d));

		// Check equality and symmetry
		assertTrue(d.equals(equalD));
		assertTrue(equalD.equals(d));

		// Since equal, hashcodes should be equal
		assertTrue(d.hashCode() == equalD.hashCode());
		...
		assertFalse(d.equals(equalD));
		assertFalse(equalD.equals(d));
	...
	public void checkCopying() {
		...
		// Create a copy DownComer
		DownComer copy = new DownComer();

		// Assert they are not the same to begin with
		assertFalse(copy.equals(down));
		...
		Object clone = down.clone();

		assertNotNull(clone);
		assertFalse(clone == down);
		assertTrue(clone.equals(down));

		assertTrue(clone instanceof DownComer);

		DownComer casted = (DownComer) clone;

		assertFalse(casted == down);
		assertTrue(casted.equals(down));
	...
	public void checkVisitation() {
		...
		// created.
		assertTrue(down == visitorComponent);
		assertTrue(down.equals(visitorComponent));
