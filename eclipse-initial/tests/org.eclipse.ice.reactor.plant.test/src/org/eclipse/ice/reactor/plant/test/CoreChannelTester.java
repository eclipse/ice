...
public class CoreChannelTester {
	...
	public void checkConstruction() {
		...
		CoreChannel component = new CoreChannel();
		
		// Check the default values.
		assertEquals("Core Channel 1", component.getName());
		assertEquals("Core channel component for reactors", component.getDescription());
	...
	public void checkCopying() {
		...
		assertTrue(objectClone instanceof CoreChannel);
		
		// Cast the component.
		CoreChannel componentClone = (CoreChannel) component.clone();
	...
	private class FakeComponentVisitor implements IPlantComponentVisitor {
		...
		private CoreChannel component = null;
