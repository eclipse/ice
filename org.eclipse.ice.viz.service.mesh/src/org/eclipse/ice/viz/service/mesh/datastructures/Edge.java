...
// public class Edge extends VizObject implements IVizUpdateableListener,
/// IMeshPart {
//
// /**
// * <p>
...
// "Edge error: start and end vertices must not be null and must not have the
/// same ID.");
// }
// // Set the vertex IDs.
// vertices[0] = start;
...
// throw new IllegalArgumentException(
// "Edge error: The vertex ArrayList must not be null and must have 2
/// elements.");
// }
