...
public class MeshCanvas implements IMeshVizCanvas, IVizUpdateableListener {
	 ...
	 */
	public MeshCanvas(AbstractController mesh) {
		this.mesh = mesh;
	}
	...
	public Composite draw(Composite parent) throws Exception {
		...
		if (viewer == null) {
			throw new Exception("Error drawing mesh canvas.");
		}
		...
		viewer.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				...
				// TODO Add listener to interact with picked mesh components and
				...
				//
				// GeometrySelection selection = (GeometrySelection)
				// event.getSelection();
				//
	 ...
	 */
	private void loadMesh(AbstractController geometry) {
		if (geometry == null) {
			return;
		}
