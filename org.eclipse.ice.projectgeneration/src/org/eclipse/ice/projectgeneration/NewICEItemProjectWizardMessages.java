...
public class NewICEItemProjectWizardMessages extends NLS {
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, NewICEItemProjectWizardMessages.class);
	}

	private NewICEItemProjectWizardMessages() {
	}
}
