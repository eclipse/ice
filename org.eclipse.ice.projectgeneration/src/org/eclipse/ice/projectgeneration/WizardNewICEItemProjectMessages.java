...
public class WizardNewICEItemProjectMessages extends NLS {
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, WizardNewICEItemProjectMessages.class);
	}

	private WizardNewICEItemProjectMessages() {
	}
}
