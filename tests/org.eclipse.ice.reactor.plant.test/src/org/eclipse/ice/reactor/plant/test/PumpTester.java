...
public class PumpTester {
	...
	public void checkProperties() {
		...
		// Create a Pump with inputs and outputs, note we are
	...
	public void checkEquality() {
		// begin-user-code
		// Create two equal Pumpes with
		// nullary constructor
		Pump o = new Pump();
		o.setName("o");
		o.setDescription("Description");

		Pump equalO = new Pump();
		equalO.setName("o");
	...
	public void checkCopying() {
		...
		assertTrue(clone instanceof Pump);

		Pump casted = (Pump) clone;
