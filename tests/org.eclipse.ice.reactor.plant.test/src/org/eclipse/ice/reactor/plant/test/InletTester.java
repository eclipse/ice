...
public class InletTester {
	...
	public void checkProperties() {
		...
		// Create a Inlet with inputs and outputs, note we are
	...
	public void checkEquality() {
		// Create two equal Inletes with
		// nullary constructor
		Inlet b = new Inlet();
		b.setName("b");
		b.setDescription("Description");

		Inlet equalB = new Inlet();
		equalB.setName("b");
	...
	public void checkCopying() {
		...
		assertTrue(clone instanceof Inlet);

		Inlet casted = (Inlet) clone;
