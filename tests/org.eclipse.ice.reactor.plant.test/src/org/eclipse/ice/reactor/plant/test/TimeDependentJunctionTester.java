 ...
 */
public class TimeDependentJunctionTester {
	/**
	 * <!-- begin-UML-doc -->
	 * <p>
	...
	public void checkConstruction() {
		// begin-user-code
		TimeDependentJunction junction = new TimeDependentJunction();
	...
	public void checkProperties() {
		...
		// Create a TimeDependentJunction with inputs and outputs, note we are
	...
	public void checkEquality() {
		// begin-user-code
		// Create two equal TimeDependentJunctiones with
		// nullary constructor
		TimeDependentJunction b = new TimeDependentJunction();
		b.setName("b");
		b.setDescription("Description");

		TimeDependentJunction equalB = new TimeDependentJunction();
		equalB.setName("b");
	...
	public void checkCopying() {
		// begin-user-code
		// Create a TimeDependentJunction to copy
		TimeDependentJunction junction = new TimeDependentJunction();
		...
		// Create a copy TimeDependentJunction
		TimeDependentJunction copy = new TimeDependentJunction();

		// Assert they are not the same to begin with
		assertFalse(copy.equals(junction));

		// Copy TimeDependentJunction
		copy.copy(junction);
		...
		assertTrue(clone instanceof TimeDependentJunction);

		TimeDependentJunction casted = (TimeDependentJunction) clone;
	...
	public void checkVisitation() {
		...
		TimeDependentJunction component = new TimeDependentJunction();
