 ...
 * @author w5q
 */
public class MassFlowInletTester {
	/**
	 * <p>
	...
	public void checkConstruction() {
		MassFlowInlet inlet = new MassFlowInlet();
	...
	public void checkProperties() {
		...
		// Create a MassFlowInlet with inputs and outputs, note we are
	...
	public void checkEquality() {
		// Create two equal MassFlowInletes with
		// nullary constructor
		MassFlowInlet b = new MassFlowInlet();
		b.setName("b");
		b.setDescription("Description");

		MassFlowInlet equalB = new MassFlowInlet();
		equalB.setName("b");
	...
	public void checkCopying() {
		// Create a MassFlowInlet to copy
		MassFlowInlet inlet = new MassFlowInlet();
		inlet.setName("Name");
		...
		// Create a copy MassFlowInlet
		MassFlowInlet copy = new MassFlowInlet();
		...
		assertTrue(clone instanceof MassFlowInlet);

		MassFlowInlet casted = (MassFlowInlet) clone;
