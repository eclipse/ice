 ...
 * @author w5q
 */
public class PipeToPipeJunctionTester {
	/**
	 * <p>
	...
	public void checkConstruction() {
		PipeToPipeJunction junction = new PipeToPipeJunction();
	...
	public void checkProperties() {
		...
		// Create a PipeToPipeJunction with inputs and outputs, note we are
	...
	public void checkEquality() {
		// Create two equal PipeToPipeJunctiones with
		// nullary constructor
		PipeToPipeJunction o = new PipeToPipeJunction();
		o.setName("o");
		o.setDescription("Description");

		PipeToPipeJunction equalO = new PipeToPipeJunction();
		equalO.setName("o");
	...
	public void checkCopying() {
		// Create a PipeToPipeJunction to copy
		PipeToPipeJunction junction = new PipeToPipeJunction();
		...
		// Create a copy PipeToPipeJunction
		PipeToPipeJunction copy = new PipeToPipeJunction();

		// Assert they are not the same to begin with
		assertFalse(copy.equals(junction));

		// Copy PipeToPipeJunction
		copy.copy(junction);
		...
		// Get a cljunction to verify the cljunction() method
		...
		assertTrue(clone instanceof PipeToPipeJunction);

		PipeToPipeJunction casted = (PipeToPipeJunction) clone;
	...
	public void checkVisitation() {
		...
		PipeToPipeJunction component = new PipeToPipeJunction();
