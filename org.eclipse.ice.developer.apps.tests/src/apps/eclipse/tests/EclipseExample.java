...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>eclipse</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EclipseExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.eclipse"));
				EclipseEnvironmentStorage root = EclipseFactory.eINSTANCE.createEclipseEnvironmentStorage();
