...
public class DeleteReactorPartAction extends Action {
	 ...
	 */
	public DeleteReactorPartAction(ViewPart parent) {

		viewer = parent;

		// Set the action's tool tip text.
		setText("Delete reactor component");
		setToolTipText("Delete the selected reactor component");
	...
	public void run() {
		...
		// from its TreeViewer.
		((ReactorViewer) viewer).removeSelection();
