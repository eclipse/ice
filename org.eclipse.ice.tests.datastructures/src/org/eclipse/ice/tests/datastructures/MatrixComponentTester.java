...
public class MatrixComponentTester {
	...
	public void checkConstruction() {
		...
		// iceObject will be used in comparisons to check
		...
		// constructor's (ICEObject) info
		assertEquals(iceObject.getName(), matrixComponent.getName());
		assertEquals(iceObject.getId(), matrixComponent.getId());
