...
/**
 * <p>
 * An interface for determining what features are available for a particular
 * object(pin-power, temperature, etc). IDataProviders are anything that have
...
public interface IDataProvider {
	...
	/**
	 * <p>
	 * This operation sets the current time step for which data should be
	 * retrieved. It is 0-indexed such that time step 0 is the initial state and
	 * time step 1 is the state after the first time step. This operation should
	...
	/**
	 * <p>
	 * This operation returns all of the data (as IData[*]) related to a
	 * particular feature for this provider at a specific time step.
	 * </p>
	 * <p>
