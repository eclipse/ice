 ...
 * @author w5q
 */
public class VolumeBranch extends Junction {
	/**
	 * <p>
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof VolumeBranch)) {
			return false;
		}
	 ...
	 */
	public Object clone() {
		VolumeBranch temp = new VolumeBranch();
		temp.copy(this);
		return temp;
	}
	 ...
	 *            </p>
	 */
	public void copy(VolumeBranch otherObject) {
