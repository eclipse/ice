 ...
 * reactor. For drawing purposes, is a bounding structure around the core
 * channels.
 * </p>
 * 
 * @author w5q
...
public class PointKinetics extends PlantComponent {
	 ...
	 */
	public Object clone() {
		PointKinetics temp = new PointKinetics();
		temp.copy(this);
		return temp;
	}
	 ...
	 *            </p>
	 */
	public void copy(PointKinetics otherObject) {
