...
/**
 * <p>
 * A component to connect subchannels. For the purpose of drawing, it is
...
public class SubchannelBranch extends Junction {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof SubchannelBranch)) {
			return false;
		}
	 ...
	 */
	public Object clone() {
		SubchannelBranch temp = new SubchannelBranch();
		temp.copy(this);
		return temp;
	}
	 ...
	 *            </p>
	 */
	public void copy(SubchannelBranch otherObject) {
