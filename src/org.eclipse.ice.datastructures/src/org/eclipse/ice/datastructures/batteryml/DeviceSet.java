 ...
 *       &lt;sequence>
 *         &lt;element name="Device" type="{BatteryML:2.0}DeviceRefType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class DeviceSet {
    ...
    protected List<DeviceRefType> device;
    @XmlAttribute
     ...
     * 
     */
    public List<DeviceRefType> getDevice() {
        if (device == null) {
            device = new ArrayList<DeviceRefType>();
        }
        return this.device;
    }
