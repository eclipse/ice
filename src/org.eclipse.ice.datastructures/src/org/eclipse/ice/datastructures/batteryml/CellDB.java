 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Cell" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "CellDB")
public class CellDB {

    @XmlElement(name = "Cell")
    protected List<CellDBEntryType> cell;
     ...
     * {@link CellDBEntryType }
     * 
     * 
     */
    public List<CellDBEntryType> getCell() {
        if (cell == null) {
            cell = new ArrayList<CellDBEntryType>();
        }
        return this.cell;
    }
