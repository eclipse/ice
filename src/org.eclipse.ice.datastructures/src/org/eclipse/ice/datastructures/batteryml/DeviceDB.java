 ...
 *       &lt;sequence>
 *         &lt;element ref="{BatteryML:2.0}Device" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{BatteryML:2.0}DeviceSet" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "DeviceDB")
public class DeviceDB {

    @XmlElement(name = "Device")
    protected List<DeviceDBEntryType> device;
    @XmlElement(name = "DeviceSet")
     ...
     * {@link DeviceDBEntryType }
     * 
     * 
     */
    public List<DeviceDBEntryType> getDevice() {
        if (device == null) {
            device = new ArrayList<DeviceDBEntryType>();
        }
        return this.device;
    }
