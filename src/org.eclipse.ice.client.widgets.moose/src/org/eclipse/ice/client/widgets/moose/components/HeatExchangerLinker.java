 ...
 * {@link HeatExchanger} properties (length, radius, etc. and its base geometric
 * properties) with the {@link Entry} instances in a {@link DataComponent}.
 * 
 * @author Jordan
 * 
 */
	...
	public List<EntryListener> linkComponents(PlantComponent plantComp,
		...
		if (plantComp != null && dataComp != null) {
			BaseVisitor visitor = new BaseVisitor() {
				 ...
				 */
				@Override
				public void visit(final HeatExchanger comp) {
					Entry entry;
