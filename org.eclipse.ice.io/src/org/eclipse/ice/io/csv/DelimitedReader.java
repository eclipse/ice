...
/**
 * This class implements the IReader interface to provide a base class for text
 * files with a delimiter. It can read any well-formed delimited file. It stores
 * its results in a ListComponent<String[]> on the Form returned from read().
 * Each String [] in the ListComponent is a line of the file, split and trimmed
 * but uncast. Clients must know the concrete type to which they want to cast.
 *
 * Comments are ignored and begin with the "#" character.
 *
 * The delimiter must be set by subclasses during construction. It is a " " by
 * default. Likewise, the type name must be specified too.
 *
 * @author Jay Jay Billings
 *
 */
public class DelimitedReader implements IReader {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(DelimitedReader.class);
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.eclipse.ice.io.serializable.IReader#findAll(org.eclipse.core.
